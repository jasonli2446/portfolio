...
export default function Experience() {
  return (
    <motion.div
      ...
      className="w-full"
    >
      <h2 className="text-[min(28px,4vh)] lg:text-[min(20px,2.5vh)] font-bold mb-4 lg:mb-1 underline decoration-2">Experience</h2>
      <div className="space-y-3 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-1">
        {experiences.map((exp, index) => (
          ...
          >
            ...
            <p className="text-[min(13px,1.6vh)] lg:text-[min(10px,1.2vh)] text-gray-600 mt-1 lg:mt-0.5 lg:line-clamp-2">{exp.description}</p>
          </motion.div>
        ))}
      </div>
    </motion.div>
